...
3. **조직도 차트 수정**  
   ...
   - **[이미지-7]**: 팀 수정, 삭제 버튼
   ![](../../uengine-image/process-gpt/organization_chart_chat5.png)
